...
const IssueTable = ({ selectedFilters }) => {
  ...
  console.log({ tipus, gravetat, prioritat});
              ...
              <tr key={issue.id}>
                <td>
                  <span
                    className="dot"
                    style={{
                      backgroundColor: getColorByName(tipus, issue.tipus)
                    }}
                  />
                </td>
                <td>
                  <span
                    className="dot"
                    style={{
                      backgroundColor: getColorByName(gravetat, issue.gravetat)
                    }}
                  />
                </td>
                <td>
                ...
                <td>
                  {new Date(issue.data_creacio).toLocaleDateString()}
                </td>
                <td>
