// src/components/SeverityForm.jsx
...
export default function SeverityForm({ isEdit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isEdit
      ? `https://issue-tracker-c802.onrender.com/api/severity/${id}/`
      : `https://issue-tracker-c802.onrender.com/api/severity/`;
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-buttons">
        <button type="submit" className="create-issue-button">
          {isEdit ? 'Save Changes' : 'Create Severity'}
        </button>
      </div>
    </form>
  );
